...
func MayorPage(rootArgs l.RootArgs, messages []ChatMessage, devMode bool, worldName string, mayorName string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<style>\n\t\t\thtml,\n\t\t\tbody {\n\t\t\t\toverflow: hidden !important;\n\t\t\t\toverscroll-behavior: none !important;\n\t\t\t\tposition: fixed !important;\n\t\t\t\twidth: 100% !important;\n\t\t\t\theight: 100% !important;\n\t\t\t}\n\t\t\t/* Override wrapper min-h-screen (100vh = large viewport on mobile, taller than visible area) */\n\t\t\tbody > div:first-child {\n\t\t\t\theight: 100% !important;\n\t\t\t\tmin-height: 0 !important;\n\t\t\t\toverflow: hidden !important;\n\t\t\t}\n\t\t\tbody > div:first-child > main {\n\t\t\t\tmin-height: 0 !important;\n\t\t\t\toverflow: hidden !important;\n\t\t\t}\n\t\t</style> <div id=\"mayor-container\" class=\"relative flex flex-col h-full\" data-signals=\"")
			if templ_7745c5c3_Err != nil {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pages/mayor.templ`, Line: 27, Col: 119}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pages/mayor.templ`, Line: 102, Col: 199}
			}

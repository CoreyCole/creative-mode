...
1. If `$CM_SWARM_HANDOFF_PATH` is set, read the handoff document. If this is a revision (attempt > 1), the handoff contains project-review feedback that MUST be addressed.

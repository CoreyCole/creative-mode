...
![Uploading Generated Image February 13, 2026 - 10_48PM.jpeg…]()
...
| **Opus 4.6** | Opus runs live inside the product — every world modification spawns a Claude Code session where Opus edits Rust/Bevy source, rebuilds WASM, and deploys. AI mayors use Opus to understand requests, plan changes, and call APIs for assets and audio. The codebase itself was also generated by Opus — I directed at a high level while working full-time. |
